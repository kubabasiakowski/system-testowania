            						...
            						<div class="panel-body">
                    					...
                    					<table class="table" width="808" align="left" height="198" valign="top" cellspacing="0" cellpadding="0" >
											...
											<tr>
												...
												<td><a href="{{ url('allQuestions', $question->id) }}" class="btn btn-primary">
			                                    Zarządzaj
			                                </a></td>
											</tr>
											...
											@endforeach
											<tr>
												<td><a href="{{ url('allQuestions') }}" class="btn btn-primary">Wróć do pełnej listy</a></td>
											</tr>
											</tbody>
										</table>
