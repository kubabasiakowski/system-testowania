                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <!--<div class="form-group{{ $errors->has('index_number') ? ' has-error' : '' }}">
                            <label for="index_number" class="col-md-4 control-label">Numer indeksu</label>

                            <div class="col-md-6">
                                <input id="index_number" type="text" class="form-control" name="index_number" value="{{ old('index_number') }}" >
