  ...
  <nav class="navbar navbar-inverse">
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav">
        ...
        <li><a href="{{ '/availableTests' }}">Dostepne testy</a></li>
        <li><a href="{{ '/solvedTests' }}">Rozwiązane testy</a></li>
      </ul>
      <ul class="nav navbar-nav navbar-right">
        @if(Auth::check())
          <li><a href="/student"><span class="glyphicon glyphicon-cog"></span> {{Auth::user()->name}}</a></li>
          <li>
              <a href="{{ route('logout') }}"
