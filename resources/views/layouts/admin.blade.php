  ...
  <nav class="navbar navbar-inverse">
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav">
        ...
        <li><a href="{{ '/allUsers' }}">Zarządzaj użytkownikami</a></li>
        <li><a href="{{ '/allTests' }}">Testy</a></li>
      </ul>
      <ul class="nav navbar-nav navbar-right">
        @if(Auth::check())
          <li><a href="/admin"><span class="glyphicon glyphicon-cog"></span> {{Auth::user()->name}}</a></li>
          <li>
              <a href="{{ route('logout') }}"
